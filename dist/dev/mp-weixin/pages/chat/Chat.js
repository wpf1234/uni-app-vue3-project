...
if (!Array) {
  ...
  (_component_ellipse + _component_path + _component_circle + _component_g + _component_svg)();
}
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    E: common_vendor.o((...args) => $options.start && $options.start(...args)),
    F: common_vendor.o((...args) => $options.end && $options.end(...args))
  };
}
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-c7e36a8d"], ["__file", "F:/Vue-project/my-vue3-project/src/pages/chat/Chat.vue"]]);
